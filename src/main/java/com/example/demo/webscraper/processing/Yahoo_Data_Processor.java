...
public class Yahoo_Data_Processor {
    ...
    public static void cut_future_records(List<Historical_Data> records, ZonedDateTime day){
        for(int i=0; i<records.size(); i++){
            Historical_Data record = records.get(i);
